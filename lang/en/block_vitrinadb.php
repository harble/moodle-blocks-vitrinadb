...
$string['channels'] = 'Channels filter';
$string['channels_help'] = 'Optional list of channels to display. Use commas or semicolons (full-width or half-width) to separate multiple channel names.';
...
$string['tabtitle_greats'] = 'Outstanding courses';
$string['tabtitle_premium'] = 'Premium courses';

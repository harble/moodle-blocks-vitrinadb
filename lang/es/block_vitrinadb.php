...
/**
 * Strings for component 'block_vitrinadb', language 'es'
 *
...
$string['catalog'] = 'Búsqueda de elementos';
...
$string['sourcecourse_help'] = 'Elija el curso cuya actividad de base de datos proporcionará los recursos mostrados por este bloque.';
...
$string['pluginname'] = 'Vitrina de cursos DB';
...
$string['privacy:metadata'] = 'El bloque de vitrina de cursos DB no almacena datos personales.';
$string['ratingmanager'] = 'Manejador de la valoración';
...
$string['tabtitle_default'] = 'Todos los elementos';
$string['tabtitle_greats'] = 'Elementos mejor valorados';
$string['tabtitle_premium'] = 'Elementos destacados';
$string['tabtitle_recents'] = 'Publicados recientemente';
